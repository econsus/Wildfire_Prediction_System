...
#slhf=pd.read_csv('slhf_csv.csv')
#sshf=pd.read_csv('sshf_csv.csv')
...
def sorted_data(data):
    df=sort_csv(data,['time','latitude','longitude'])
    return df
...
#df.to_csv('Variables_with_index.csv',reset)
# ds.to_csv('Variables_without_index.csv',index=False,index_label=False)
